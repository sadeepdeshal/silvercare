...
export const DoctorReg = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('doctorStep1Data', JSON.stringify(formData));
    
    // Navigate to step 2
    navigate('/doctor/signup-step2');
  };

  // Load saved data if returning from step 2
  useEffect(() => {
    const savedStep1Data = localStorage.getItem('doctorStep1Data');
    if (savedStep1Data) {
        ...
        <div className={styles.rightSection}>
          <div className={styles.formContainer}>
            <div className={styles.formHeader}>
              <h2 className={styles.formTitle}>Register as a Doctor</h2>
