...
// Send approval email to health professional
const sendHealthProfessionalApprovalEmail = async (healthProfessionalData) => {
  try {
    const tempPassword = generateTempPassword();
    ...
    const mailOptions = {
      ...
      to: healthProfessionalData.email,
      subject: '🎉 Your Health Professional Account Has Been Approved - SilverCare',
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>🎉 Congratulations!</h1>
              <p>Your Health Professional Account Has Been Approved</p>
            </div>
            
            <div class="content">
              <h2>Dear ${healthProfessionalData.name},</h2>
              
              <p>We are pleased to inform you that your application to join the SilverCare platform as a mental health professional has been <strong>approved</strong>!</p>
              
              <p>Your account details:</p>
              <ul>
                <li><strong>Name:</strong> ${healthProfessionalData.name}</li>
                <li><strong>Email:</strong> ${healthProfessionalData.email}</li>
                <li><strong>Specialization:</strong> ${healthProfessionalData.specialization}</li>
                <li><strong>License Number:</strong> ${healthProfessionalData.license_number}</li>
              </ul>
              ...
              <ol>
                <li>Click the login button above or visit our website</li>
                <li>Use your email (${healthProfessionalData.email}) and the temporary password provided</li>
                <li>Complete your profile and change your password</li>
                <li>Start connecting with families and providing mental health support</li>
              </ol>
              
              <p>Welcome to the SilverCare community! We're excited to have you on board as a mental health professional.</p>
            ...
            <div class="footer">
              <p>© 2025 SilverCare Platform. All rights reserved.</p>
              <p>This email was sent to ${healthProfessionalData.email} because your health professional account was approved.</p>
            </div>
          </div>
        </body>
        </html>
    ...
    // Send email
    const info = await transporter.sendMail(mailOptions);
    console.log('Health professional approval email sent successfully:', info.messageId);
    ...
    console.error('Error sending health professional approval email:', error);
    throw error;
  }
};
...
module.exports = {
  ...
  sendHealthProfessionalApprovalEmail,
  testEmailConnection,
